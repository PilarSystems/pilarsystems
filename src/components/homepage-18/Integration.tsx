                ...
                <div className="lg:max-w-[483px] max-w-full max-sm:min-h-[433px]">
                  <div className="p-2.5 rounded-[20px] relative z-[10] overflow-hidden">
                    ...
                    <figure className="p-8 bg-white dark:bg-background-5 rounded-xl space-y-6">
                      ...
                      {/* Code-only Visual – clean Apple/Pilar Look */}
                      <div className="max-w-[385px] w-full">
                        <div className="rounded-2xl border border-secondary/10 dark:border-accent/10 bg-gradient-to-br from-white via-accent/5 to-accent/10 dark:from-background-4 dark:via-background-6 dark:to-background-7 h-[220px] md:h-[260px] p-5 flex flex-col justify-between">
                          {/* Top: URL + Status */}
                      ...
                      <div className="rounded-2xl overflow-hidden max-w-[400px] w-full">
                        <div className="h-[220px] md:h-[260px] rounded-2xl bg-gradient-to-br from-background-4 via-background-6 to-background-8 dark:from-background-4 dark:via-background-6 dark:to-background-8 p-5 flex flex-col justify-between">
                          ...
                          <div className="flex items-center justify-between text-[11px] text-accent/80 mb-3">
                            ...
                            <span className="text-accent/80 text-[10px]">Verbunden</span>
                          </div>
                          <div className="flex items-center justify-between text-[11px] text-accent/80 mb-3">
                            <div className="flex items-center gap-2">
                              <span className="size-6 rounded-full bg-white/10 flex items-center justify-center">
                          ...
                          <div className="flex items-center justify-between text-[11px] text-accent/80 mb-4">
                            ...
                            <span className="text-accent/70 text-[10px]">Testläufe</span>
                          </div>
                          ...
                          <div className="rounded-xl bg-white/5 border border-white/12 p-3 space-y-2">
                            <div className="flex items-center justify-between text-[11px] text-accent/80">
                              ...
                              <span className="text-[10px] text-accent">✓ erfolgreich</span>
                            </div>
                            <div className="h-1.5 rounded-full bg-white/5 overflow-hidden">
                              <div className="h-full w-[80%] rounded-full bg-gradient-to-r from-accent to-accent/60" />
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="lg:max-w-[483px] max-w-full max-sm:min-h-[433px]">
                  <div className="p-2.5 rounded-[20px] relative z-[10] overflow-hidden">
                    ...
                    <figure className="p-8 bg-white dark:bg-background-5 rounded-xl space-y-6">
                      ...
                      <div className="rounded-2xl overflow-hidden max-w-[400px] w-full">
                        <div className="h-[220px] md:h-[260px] rounded-2xl bg-gradient-to-br from-white via-accent/5 to-accent/10 dark:from-background-4 dark:via-background-6 dark:to-background-7 p-5 flex flex-col gap-3">
                          ...
                          <div className="space-y-2 text-[11px]">
                            ...
                            <div className="flex items-start gap-2">
                              <span className="mt-[3px] size-4 rounded-full bg-accent/10 flex items-center justify-center text-[10px] text-secondary/70 dark:text-accent/70">
                                C
                              </span>
                              <p>
                ...
                <div className="lg:max-w-[483px] max-w-full max-sm:min-h-[433px]">
                  <div className="p-2.5 rounded-[20px] relative z-[10] overflow-hidden">
                    ...
                    <figure className="p-8 bg-white dark:bg-background-5 rounded-xl space-y-6">
                      ...
                      {/* Code-only Visual – stärker, aber gleiche Palette */}
                      <div className="rounded-2xl overflow-hidden max-w-[400px] w-full">
                        <Link href="/process-01">
                          <div className="h-[220px] md:h-[260px] rounded-2xl bg-gradient-to-br from-accent via-accent/80 to-secondary/90 dark:from-accent dark:via-accent/80 dark:to-secondary p-5 flex flex-col justify-between cursor-pointer transition-transform duration-300 hover:scale-[1.02]">
